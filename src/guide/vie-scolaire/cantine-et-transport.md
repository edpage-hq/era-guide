...
Cette page couvre la gestion de la cantine (menus et pointage) et le suivi
du transport scolaire (affectation des élèves aux circuits et pointage des
présences). Les circuits de transport eux-mêmes sont créés par
l'administrateur ; en tant que vie scolaire, vous affectez les élèves aux
circuits existants et pointez leur présence à la montée et à la descente.
...
La liste des menus se filtre par site. **Modifier** permet de corriger la
date ou le contenu d'un menu déjà publié ; **Supprimer** l'efface
définitivement après confirmation — action irréversible.
...
La liste des affectations se filtre par circuit. **Retirer** désaffecte un
élève de son circuit après confirmation.
