...
As an administrator, you have access to your school's entire structure:
base configuration, staff, students, pricing, timetables, and report cards.
It's ERA's most complete role — most other roles (teacher, front office,
cashier...) work within a scope you've set up beforehand.
...
| [Year-end decisions](/en/guide/admin/decisions-fin-annee)              | Proposing and validating, class by class, who moves up, repeats or leaves                                                                                                                       |
| [Re-enrollments](/en/guide/admin/reinscriptions)                       | Re-enrolling students into the next year from the decisions, flagging unpaid balances                                                                                                           |
