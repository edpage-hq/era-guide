...
En tant qu'administrateur, vous avez accès à l'ensemble de la structure de
votre établissement : configuration de base, personnel, élèves, tarification,
emplois du temps et bulletins. C'est le rôle le plus complet d'ERA — la
plupart des autres rôles (enseignant, secrétariat, caisse...) travaillent
dans un périmètre que vous avez préalablement mis en place.
...
| [Décisions de fin d'année](/guide/admin/decisions-fin-annee)             | Proposer et valider, classe par classe, qui passe, redouble ou quitte l'établissement                                                                                                                                     |
| [Réinscriptions](/guide/admin/reinscriptions)                            | Réinscrire les élèves dans l'année suivante à partir des décisions, en signalant les impayés                                                                                                                              |
